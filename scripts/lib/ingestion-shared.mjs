...
const ALLOW_LOCAL_HEURISTIC_AUTO_APPROVE = process.env.ALLOW_LOCAL_HEURISTIC_AUTO_APPROVE === "true";
...
const LOCAL_POSITIVE_LEAN_SOURCE_MATCHES = new Set([
  "rtvslo.si",
  "siol.net",
  "24ur.com",
  "dnevnik",
...
const SOURCE_QUALITY_PROFILES = [
  ...
  { match: "rtvslo.si", score: 0.78 },
  { match: "siol.net", score: 0.7 },
  { match: "24ur.com", score: 0.68 },
  { match: "dnevnik", score: 0.68 },
  { match: "delo.si", score: 0.78 },
  { match: "global news", score: 0.72 },
  { match: "cbc", score: 0.72 },
  { match: "ctv news", score: 0.68 },
...
export const inferReviewDecision = ({
  ...
  config: {
    ...
    LOCAL_POSITIVE_LEAN_SOURCE_MATCHES,
    ...
    thresholds: {
      ...
      allowLocalHeuristicAutoApprove: ALLOW_LOCAL_HEURISTIC_AUTO_APPROVE,
    },
  },
});
